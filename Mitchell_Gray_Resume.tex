...
%Based on the number of point you want to add add the "\resumeItem" for each point you want to add.
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem {Nominated for Course Staff Excellence Award twice $\cdot$ Created and led review sessions for hundreds of students $\cdot$ Proctored exams and 
        instructed the other proctors $\cdot$ Taught class sections and held office hours weekly $\cdot$ Answered Q\&A posts.
        }
    \resumeItemListEnd
