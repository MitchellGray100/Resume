...
\section{\textcolor{customred}{Education}}
  \resumeSubHeadingListStart
    \resumeSpecialSubheadingGT
      {Georgia Tech, Atlanta, GA}{Jan 2025 -- Dec 2027}
      {Master's of Science, Computer Science}{Machine Learning}%Insert GPA here%
...
\section{\textcolor{customred}{Relevant Work Experience}}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem {Adding functionality to the Globally Distributed Database on the Shard Native Replication team $\cdot$ 
      Writing Distributed Systems code in \textbf{C}, \textbf{Java}, and \textbf{PL/SQL} $\cdot$ Unit-Testing large-scale software 
      $\cdot$ Utilizing \textbf{Raft} for consensus.}
      \resumeItemListEnd
